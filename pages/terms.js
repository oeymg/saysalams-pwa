  ...
  return (
    <Layout>
      <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <p style={{ color: 'var(--muted)', marginBottom: '1rem' }}>Last Updated: 9th of September 2025</p>

        <p style={{ color: '#2e2e2e', lineHeight: 1.7 }}>
        ...
        <ul style={{ color: '#2e2e2e', lineHeight: 1.8, margin: 0 }}>
        ...
        <Collapsible title="8. Governing Law">
          <p style={{ color: '#2e2e2e', lineHeight: 1.8, margin: 0 }}>
